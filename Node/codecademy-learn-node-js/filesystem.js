...
// When running JavaScript code on a browser, it’s important for a script to have only limited access 
// to a user’s filesystem.This technique of isolating some applications from others is known as sandboxing.
// Sandboxing protects users from malicious programs and invasions of privacy.

// In the back-end, however, less restricted interaction with the filesystem is essential. 
...
// We define an error-first callback function which expects an error to be passed as the first 
// argument and data as the second. If the error is present, the function will print 
...
fs.readFile('./finalFile.txt', 'utf-8', readDataCallback); // we don't have this file 
